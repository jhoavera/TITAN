Estructura de Prompt para Reorganización y Refactorización del Proyecto
Objetivo General
Refactorizar integralmente el workspace del proyecto para eliminar desorden en la carpeta raíz, centralizar toda la estructura dentro de Scripts/Despliegue/Titan-MSP-v13.0, y traducir todo el contenido a español técnico empresarial, manteniendo la integridad de los 1200+ elementos existentes.
...
❌ REUBICAR:
  - Todo contenido de testing → Scripts/Despliegue/Titan-MSP-v13.0/
