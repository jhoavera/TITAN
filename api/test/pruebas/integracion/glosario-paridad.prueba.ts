...
describe('Migración Glosario: paridad Fastify <-> Hono', () => {
  ...
  beforeEach(async () => {
    ...
    // levantar instancia Fastify-compat (respaldado por Hono) y registrar rutas legacy
  ...
  it('Parity: CRUD responses should match between Fastify and Hono', async () => {
    // Crear
    const payload = { termino: 'paridad-test', definicion: 'Definición paridad suficientemente larga para pasar validación (ejemplo de prueba)', categoria: 'TERMINO_TECNICO' }
